      ...
      <div>
        {user ? (
          <div className="flex items-center gap-5">
            ...
            <Popover>
             <PopoverTrigger>
             <Button className="h-[35px] w-[35px] rounded-full bg-emerald-600 font-medium text-xl hover:cursor-pointer">{user?.name?.[0]?.toUpperCase() || user?.email?.[0]?.toUpperCase() || "U"}</Button>
             </PopoverTrigger>
